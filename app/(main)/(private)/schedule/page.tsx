// This code defines a `SchedulePage` component that is responsible for rendering a user's schedule page.
// It first checks if the user is authenticated using Clerk's authentication system;
// if not, the user is redirected to the sign-in page. Then,
// it queries the database for the user's schedule,
// including any availability information associated with it.
// Once the schedule data is retrieved, it renders the page within a card layout,
