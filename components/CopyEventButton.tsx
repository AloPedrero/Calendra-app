...
//returns the appropiate button level based on the current copy state
...
//Reusable button component that coppies a URL clipboard
export function CopyEventButton({
    ...
    variant,
    size,
    ...props //any pther button props like disabled, type, etc.
