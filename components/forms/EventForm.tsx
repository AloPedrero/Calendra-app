...
// Destructure the `event` object from the props and Define the shape (TypeScript type) of the expected props
  ...
  async function onSubmit(values: z.infer<typeof eventFormSchema>) {
    ...
    try {
      ...
      if (error instanceof Error) {
        ...
        form.setError("root", {
          message: "And unexpected error occurred. Please try again later.",
        });
      }
    }
  }
                      ...
                      startDeleteTransition(async () => {
                        try {
                          ...
                          if (error instanceof Error) {
                            ...
                            form.setError("root", {
                              message:
                                "And unexpected error occurred. Please try again later.",
                            });
                          }
                        }
                      });
