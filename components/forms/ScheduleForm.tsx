...
type Availability = {
  ...
  //if you dont use the [number] you are refering the entire array, we want the individual values
};
  ...
  async function onSubmit(values: z.infer<typeof scheduleFormSchema>) {
    try {
      ...
      if (error instanceof Error) {
        form.setError("root", {
          message: `There was an error setting the meeting:  ${error.message}`,
        });
      }
    }
  }
